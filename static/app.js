...
class Chatbox {
    constructor() {
        ...
        this.state = false; // Set the initial state to closed
        this.messages = [];
        this.intents = [];

        this.display();
        this.loadResponses();
        this.toggleState(); // Open the chatbox when the page is loaded
    }
    ...
    toggleState() {
        ...
        // Toggle the height property based on the state
